...
export const Position = z.union([z.tuple([z.number(), z.number()]), z.tuple([z.number(), z.number(), z.number()])]);
...
export const GeometryCollection = z.object({
  ...
  geometries: z.array(z.union([Point, LineString, Polygon, MultiPoint, MultiLineString, MultiPolygon])),
});
export type GeometryCollection = z.infer<typeof GeometryCollection>;

const Geometry = z.union([Point, LineString, Polygon, MultiPoint, MultiLineString, MultiPolygon, GeometryCollection]);
